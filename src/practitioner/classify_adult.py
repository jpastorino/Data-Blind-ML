...
if __name__ == "__main__":
    ...
    # ################################################################################
    # LOADING DATA
    adult_synthetic = np.load("../../data/generated/adult_synt.npz", allow_pickle=True)
    adult_data = adult_synthetic["data"]

    print(f"""Adult DS Synthetic data shape:{adult_data.shape}""")
    ...
    eval.evaluate_model("A9BC0", MODEL_NAME, model, pre_proc)
